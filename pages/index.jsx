      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between">
            <h2 className="text-xl font-burtons cursor-pointer dark:text-white">wavylmao</h2>
        ...
        <section>
          <div>
            ...
            <p className="py-2 leading-8 text-gray-800 dark:text-gray-300">
        ...
        <section>
          <div>
            ...
            <p className="py-2 leading-8 text-gray-800 dark:text-gray-300">
              ...
              Voluptatibus et sunt incidunt similique eum aliquid odit rem
              voluptates, eligendi delectus maxime laborum, dolorum omnis.
              Itaque repudiandae reprehenderit non. Amet, sapiente.
            </p>
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-300">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ea
              provident possimus, veniam id aperiam ipsa?
            </p>
          </div>
